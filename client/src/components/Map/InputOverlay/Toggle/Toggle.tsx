    ...
    <div className='toggle-container'>
      <fieldset className='toggle-fieldset'>
        ...
        <div className="switch-toggle">
          <input className='toggle-input' id={`${props.name}-left`} name={props.name} type="radio" onChange={onChange} value={props.left}/>
          <label className='toggle-input-label' htmlFor={`${props.name}-left`}>{props.left}</label>
          <input className='toggle-input' id={`${props.name}-center`} name={props.name} type="radio" onChange={onChange} value={''} defaultChecked/>
          <label className='toggle-input-label' htmlFor={`${props.name}-center`}>{props.center}</label>
          <input className='toggle-input' id={`${props.name}-right`} name={props.name} type="radio" onChange={onChange} value={props.right}/>
          <label className='toggle-input-label' htmlFor={`${props.name}-right`}>{props.right}</label>
